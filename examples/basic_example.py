...
def experiment_on_simple_data(n_data,
    ...
    model = GeometricClassifierAutotwirlJax(
        feature_map, ansatz, num_wires, twirled_bool, c4_rep_on_qubits, qml.Z(0)@qml.Z(1)@qml.Z(2)@qml.Z(3))
...
def plot_metrics_from_runs(run_names, figname, which_plot='loss', valid_data=None, config=None):
    ...
    for run_name in run_names:
        ...
        if which_plot == 'loss':
            ...
            x_axis, y_axis, _ = roc_curve(
                valid_data[1], preds, drop_intermediate=False)
